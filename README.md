...
**Play now:** [jinster.github.io/jhitster](https://jinster.github.io/jhitster/)

## How It Works

1. **Pick your packs** -- choose from song collections like Billboard Hot 100 or K-Pop Hits
...
Songs are looked up on-demand via the iTunes Search API, so every song gets a 30-second clip when available.
